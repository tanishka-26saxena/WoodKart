...
const Home: React.FC = () => {
    ...
    const vendorData: Record<string, { title: string; img: string }[]> = {
  All: [
    { title: "Vendor A", img: "./src/ph.jpg" },
    { title: "Vendor B", img: "./src/ph.jpg" },
    { title: "Vendor C", img: "./src/ph.jpg" },
    { title: "Vendor D", img: "./src/ph.jpg" },
    { title: "Vendor E", img: "./src/ph.jpg" },
    { title: "Vendor F", img: "./src/ph.jpg" },
  ],
};
...
<div className="flex flex-col">
  ...
  <div className="hidden lg:flex flex-col bg-gray-100 rounded-xl" style={{paddingTop: "20px", paddingBottom: "20px", paddingLeft: "20px", paddingRight: "20px"}}>
...
<div className="hidden lg:grid grid-cols-6 gap-8 mt-6" style={{marginTop:"20px"}}>
  {vendorData[activeCategory]?.map((item) => (
...
<div className="lg:hidden rounded-xl" style={{paddingTop: "12px", paddingBottom: "12px" }} >
